...
#if !defined(NXT_IOMAP_Access__H_)
...
intrinsic const IOMAPOUTPUT  variableIndex(nMotorIOMap, opcdSourceExternMemoryRef, kExternMotorIOMAPAddress);
...
intrinsic const IOMAPINPUT  variableIndex(nSensorIOMap, opcdSourceExternMemoryRef, kExternSensorIOMAPAddress);
...
intrinsic IOMAPUI  variableIndex(nUiOMap, opcdSourceExternMemoryRef, kExternUiIOMAPAddress);
...
intrinsic TContactTable variableIndex(BluetoothContactTable,		opcdSourceExternMemoryRef, kExternBluetoothContactTableAddress);
intrinsic TConnectTable variableIndex(BluetoothConnectionTable, opcdSourceExternMemoryRef, kExternBluetoothConnectionTableAddress);
intrinsic TBRICKDATA    variableIndex(BrickData,                opcdSourceExternMemoryRef, kExternBrickData);
