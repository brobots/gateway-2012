...
typedef enumWord TFileIOResult // NOTE the "enumWord" -- ROBOTC compiler will assign it 16-bit value!!!
{
...
typedef enumWord THighSpeedState
{
  HS_Unassigned       = 0,
  HS_INITIALISE       = 1,
  HS_INIT_RECEIVER    = 2,
...
typedef enumWord THiSpeed_Mode
{
  hsInactive        = 0,
  hsRawMode         = 1,
  hsMsgModeMaster   = 2,
