...
|*  Line Track for Distance (Natural Language)  *|
\************************************************/

// This program follows a black line on a white surface for 7.5 rotations.

task main()
{
  lineTrackForRotations(7.5);     // track a dark line on a light surface for 7.5 rotations
  stop();                         // stop the robot
}
