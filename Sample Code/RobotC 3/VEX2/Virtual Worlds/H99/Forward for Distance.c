...
// This program goes forward for a specific distance using the encoders.

task main()
{
  SensorValue[rightEncoder] = 0;          // reset encoder to 0

  while(SensorValue[rightEncoder] < 720)  // while the right encoder value is less than 720 (two rotations):
  {
                              // move forward:
